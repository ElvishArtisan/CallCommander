...
//
//    $Id: cwrap.cpp,v 1.3 2008/11/11 14:00:23 fredg Exp $
//
...
int main(int argc,char *argv[])
{
  ...
  //
  // Get Size of Source File and Write Headery
  //
  ...
  fprintf(output_desc,"char %s[%lld] = {\n",var_name,(long long)stat.st_size+1);
