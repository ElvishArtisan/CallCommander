...
//
//    $Id: mlhpiinformation.h,v 1.4 2012/06/26 21:30:02 cvs Exp $
//
...
#ifndef MLHPIINFORMATION_H
#define MLHPIINFORMATION_H

#include <stdint.h>

class MLHPIInformation
{
 public:
  MLHPIInformation();
